...
tags = {
    names = {"main","www","geany",4,5,6,7,8,9},
    layout = {layouts[4],layouts[10],layouts[10],layouts[4],layouts[1],layouts[1],layouts[1],layouts[1],layouts[1]}
}
...
diskwidget.image = image("/home/ryan/.awesome_icons/xbm8x8/diskette.png")
...
baticon.image = image("/home/ryan/.awesome_icons/xbm8x8/bat_full_01.png")
-- Initialize widget
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "F8",   function () awful.util.spawn("import -window root " .. os.getenv("HOME") .. "/Pictures/screenshot-" .. os.time() .. ".png") end)
)
